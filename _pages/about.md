...
<div class='paper-box'>
  ...
  <div class='paper-box-text'>
    ...
    <ul>
      <li>LogicReward is a reward function that evaluates unstructured natural language reasoning and provides step-level, symbolically guided rewards.</li>
    </ul>
  </div>
</div>
...
- *2025.11*, Invited to [NICE](https://nice-intl.github.io) (NLP Academic Exchange) to introduce NeurIPS 2025 paper [MuSLR](https://llm-symbol.github.io/MuSLR/). \| [\[video\]](bilibili.com/video/BV1V427BQEJg/?spm_id_from=333.1387.upload.video_card.click)
